...
<body>
    ...
    <section id="hero" class="hero">
        ...
        <div class="hero-content" data-scroll data-scroll-speed="-5">
            ...
            <p> &emsp; &emsp; <br> <br>Test Test Test (test) <br> <br>
                &emsp; &emsp;Test Test Test (test) <br> <br>
                &emsp; &emsp;Test Test Test (test)
            </p>
        ...
        <div class="hero-img">
            <div class="glowing-circle">
                ...
                <span></span>
                <div class="image">
                    <img src="../public/IMAGES/Ork.png" alt="REEEEEEEEEEEEEEEEE">
                </div>
            </div>
        </div>
